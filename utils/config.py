...
class Config(BaseSettings):
    ...
    SYS_ROUTER_SYNCROUTES: Optional[str] = DefaultConfig["SYSTEM"][
    ...
    SECRET_JWT_ALGORITHM: Optional[str] = DefaultConfig["SECURITY"][
        "SECRET_JWT_ALGORITHM"
    ]
    ...
    REDIS_MAX_CONNECTIONS: Optional[int] = DefaultConfig["CACHE"][
